...
# colors
acpi_format_begin=$(get_tmux_option "@acpi_format_begin" "#[fg=white]")
...
acpi_icon_adapter_connected=$(get_tmux_option "@acpi_icon_adapter_connected" " ")
...
acpi_thermal_status="${acpi_format_begin}#($CURRENT_DIR/scripts/acpi-thermal-status.sh)${acpi_format_end}"
